    ...
    public async Task<ActionResult<IEnumerable<CustomerProfile>>> GetCustomerProfiles()
    {
        ...
        return await Task.FromResult(
            new CustomerProfile[]
            {
                new()
                {
                    Id = Guid.NewGuid().ToString(), LastName = "Last1", FirstName = "First1", Email = "first1@tld.com"
                },
                new()
                {
                    Id = Guid.NewGuid().ToString(), LastName = "Last2", FirstName = "First2", Email = "first2t@tld.com"
                }
            });
    }
